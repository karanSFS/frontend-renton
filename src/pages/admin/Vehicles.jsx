                    ...
                    <div className="bg-white/5 p-6 rounded-2xl border border-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            <Form.Item name="name" label={<span className="text-gray-400">Vehicle Name</span>} rules={[{ required: true }]}>
                                <Input placeholder="e.g. Tesla Model 3" className="bg-dark-900 !border-none text-white placeholder:text-gray-600 rounded-lg h-10 focus:!shadow-none" />
                            </Form.Item>
                            <Form.Item name="type" label={<span className="text-gray-400">Type</span>} rules={[{ required: true }]}>
                                <Select className="custom-select no-border-select" placeholder="Select Type">
                            ...
                            <Form.Item name="description" label={<span className="text-gray-400">Description</span>} rules={[{ required: true }]} className="md:col-span-2">
                                <TextArea rows={3} placeholder="Describe the vehicle's features..." className="bg-dark-900 !border-none text-white placeholder:text-gray-600 rounded-lg focus:!shadow-none" />
                            </Form.Item>
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <Form.Item name="transmission" label={<span className="text-gray-400">Transmission</span>}>
                                        <Select className="custom-select no-border-select">
                                ...
                                <Form.Item name="capacity" label={<span className="text-gray-400">Capacity</span>}>
                                    <Input placeholder="e.g. 4 Persons" className="bg-dark-900 !border-none text-white placeholder:text-gray-600 rounded-lg h-10 focus:!shadow-none"/>
                                </Form.Item>
                            </div>
                        </div>
                         ...
                         <div className="bg-white/5 p-6 rounded-2xl border border-white/5">
                            ...
                            <div className="space-y-4">
                                <Form.Item name="pricePerDay" label={<span className="text-gray-400">Price Per Day (₹)</span>} rules={[{ required: true }]}>
                                    <InputNumber min={0} className="w-full bg-dark-900 !border-none text-white rounded-lg h-10 pt-1 focus:!shadow-none" placeholder="0.00"/>
                                </Form.Item>
                    ...
                    <div className="bg-white/5 p-6 rounded-2xl border border-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            <Form.Item name="address" label={<span className="text-gray-400">Full Address</span>} rules={[{ required: true }]} className="md:col-span-2">
                                <Input prefix={<MapPin size={16} className="text-gray-500"/>} placeholder="123 Example St, City, Country" className="bg-dark-900 !border-none text-white placeholder:text-gray-600 rounded-lg h-10 focus:!shadow-none" />
                            </Form.Item>
                            
                            <Form.Item name="lat" label={<span className="text-gray-400">Latitude</span>} rules={[{ required: true }]}>
                                <InputNumber className="w-full bg-dark-900 !border-none text-white rounded-lg h-10 pt-1 focus:!shadow-none" step="0.000001" />
                            </Form.Item>
                            ...
                            <Form.Item name="contactPhone" label={<span className="text-gray-400">Owner Contact Number</span>} rules={[{ required: true, message: 'Please provide a contact number' }]} className="md:col-span-2">
                                <Input prefix={<Phone size={16} className="text-gold-500"/>} placeholder="+91 98765 43210" className="bg-dark-900 !border-none text-white placeholder:text-gray-600 rounded-lg h-10 focus:!shadow-none" />
                            </Form.Item>
                        </div>
                    </div>
